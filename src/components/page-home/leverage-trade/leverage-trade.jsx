...
const LeverageTrade = () => {
  return (
    <section className="leverage-trade" id="leverage-trade">
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 col-lg-6">
            <div className="leverage-trade-block text-lg-left">
              ...
              <a href="#" className="leverage-trade__link d-flex align-items-center justify-content-center justify-content-lg-start">
                <p className="leverage-trade__text leverage-trade__text--blue">Learn More</p>
                <svg className="leverage-trade__symbol" width="24" height="24" stroke="#52AFEE" stroke-width="1.1"
        ...
        <div className="row">
          <div className="col-12 text-center">
            <button className="leverage-trade__button ">Get Started</button>
          </div>
        </div>
      </div>
    </section>
